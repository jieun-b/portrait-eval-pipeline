...
class ArgumentConfig(PrintableConfig):
    ...
    driving:  Annotated[Union[str, List[str]], tyro.conf.arg(aliases=["-d"])] = make_abs_path('../../assets/examples/driving/d0.mp4')  # path to driving video or template (.pkl format)
