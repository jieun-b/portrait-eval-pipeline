...
class CropConfig(PrintableConfig):
    insightface_root: str = "pretrained_model/insightface"
    landmark_ckpt_path: str = "pretrained_model/liveportrait/landmark.onnx"
    ...
    xpose_ckpt_path: str = "pretrained_model/liveportrait_animals/xpose.pth"
