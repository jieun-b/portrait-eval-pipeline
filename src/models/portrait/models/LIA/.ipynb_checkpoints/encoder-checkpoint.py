# Adapted from https://github.com/wyhsirius/LIA/blob/main/networks/encoder.py
import math
import torch
...
class Encoder(nn.Module):
    ...
    def forward(self, input_source, input_target, h_start=None):
        ...
        if input_target is not None:
            ...
            h_source, feats = self.net_app(input_source) # z_s->r
            h_target, _ = self.net_app(input_target) # z_d->r

            h_motion_target = self.fc(h_target) # w_r->d
